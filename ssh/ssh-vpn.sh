...
wget -O /etc/issue.net "https://raw.githubusercontent.com/heruhendri/premium/master/banner.conf"
...
#UPDATE MENU
wget -O updatemenu "https://raw.githubusercontent.com/heruhendri/premium/master/updatemenu.sh"
