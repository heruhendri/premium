...
clear 
echo -e "┌────────────────────────────────────────────────┐\033[0m${NC}"
echo -e "${COLOR1}|\\E[40;1;37m      SCRIPT MULTIPORT BY hendr.store       \E[0m"
...
echo -e "${COLOR1}└────────────────────────────────────────────────\033[0m${NC}"
echo -e "$COLOR1┌─────────────────┐${NC}" 
echo -e "${COLOR1} ${NC} masa aktif =$(tanggal)"
echo -e "$COLOR1└─────────────────┘${NC}"
...
echo -e "  ${WH}[${COLOR1}06${WH}]${NC} ${y}• ${WH}BACKUP  		${WH}[${COLOR1}12${WH}]	${NC} ${Lred}• ${WH}INFO    ${WH}[${COLOR1}Menu${WH}]  $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
